...
type Suspect struct {
	...
	Context *Suspect_Context `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"`
}
...
func (x *Suspect) GetContext() *Suspect_Context {
	if x != nil {
		return x.Context
	}
	return nil
...
type EpochChange struct {
	...
	Status   *EpochChange_NetworkStatus `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	...
	// PBFT view-change protocol.
	PSet []*EpochChange_SetEntry `protobuf:"bytes,5,rep,name=p_set,json=pSet,proto3" json:"p_set,omitempty"`
	// q_set contains the entries for the Q-set as defined by the classical
	// PBFT view-change protocol.
	QSet []*EpochChange_SetEntry `protobuf:"bytes,6,rep,name=q_set,json=qSet,proto3" json:"q_set,omitempty"`
}
...
func (x *EpochChange) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *EpochChange) GetStatus() *EpochChange_NetworkStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
type EpochConfig struct {
	...
	// offset of this new epoch
	Offset            uint64   `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	Loyalties         []int64  `protobuf:"varint,3,rep,packed,name=loyalties,proto3" json:"loyalties,omitempty"`
	Timeouts          []uint64 `protobuf:"varint,4,rep,packed,name=timeouts,proto3" json:"timeouts,omitempty"`
	Leaders           []uint64 `protobuf:"varint,5,rep,packed,name=leaders,proto3" json:"leaders,omitempty"`
	PlannedExpiration uint64   `protobuf:"varint,6,opt,name=planned_expiration,json=plannedExpiration,proto3" json:"planned_expiration,omitempty"`
}
...
func (x *EpochConfig) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *EpochConfig) GetLoyalties() []int64 {
	if x != nil {
		return x.Loyalties
	}
	return nil
...
func (x *EpochConfig) GetTimeouts() []uint64 {
	if x != nil {
		return x.Timeouts
	}
	return nil
...
type NetworkState_Config struct {
	...
	// Loyalties is an array of nodes' loyalty to consensus, represented as a positive integer. The greater the
	// integer the greater the nodes loyalty. If a node is consistently loyal its loyalty will increase, but if
	// a node is found to be faulty it's loyalty will decrease. If a node's loyalty were to drop below,
	// or reaches 0, the node will be prevented from participating as a leader or a primary in subsequent epochs.
	// The node each loyalty corresponds to is implicit e.g. the loyalty at the first index corresponds to the node
	// at the first index of nodes.
	Loyalties []int64 `protobuf:"varint,2,rep,packed,name=loyalties,proto3" json:"loyalties,omitempty"`
	// Timeouts is an array of the number of epochs a given node cannot participate as a leader in. Like loyalties
	// the node each timeout corresponds to is implicit.
	Timeouts []uint64 `protobuf:"varint,3,rep,packed,name=timeouts,proto3" json:"timeouts,omitempty"`
	...
	// or decreases.
	CheckpointInterval int32 `protobuf:"varint,4,opt,name=checkpoint_interval,json=checkpointInterval,proto3" json:"checkpoint_interval,omitempty"`
	...
	MaxEpochLength uint64 `protobuf:"varint,5,opt,name=max_epoch_length,json=maxEpochLength,proto3" json:"max_epoch_length,omitempty"`
	...
	// reduces Mir to PBFT.
	NumberOfBuckets int32 `protobuf:"varint,6,opt,name=number_of_buckets,json=numberOfBuckets,proto3" json:"number_of_buckets,omitempty"`
	...
	// 16 | 7 | 7 | 6 | 6 | 5 | 5 |
	// 17 | 8 | 7 | 7 | 6 | 6 | 5 |
	F int32 `protobuf:"varint,7,opt,name=f,proto3" json:"f,omitempty"`
}
...
func (x *NetworkState_Config) GetLoyalties() []int64 {
	if x != nil {
		return x.Loyalties
	}
	return nil
...
func (x *NetworkState_Config) GetTimeouts() []uint64 {
	if x != nil {
		return x.Timeouts
	}
	return nil
...
func (x *Suspect_Context) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Suspect_Context) ProtoMessage() {}

func (x *Suspect_Context) ProtoReflect() protoreflect.Message {
	mi := &file_msgs_msgs_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Suspect_Context.ProtoReflect.Descriptor instead.
func (*Suspect_Context) Descriptor() ([]byte, []int) {
	return file_msgs_msgs_proto_rawDescGZIP(), []int{20, 0}
}

func (x *Suspect_Context) GetSeqNo() uint64 {
	if x != nil {
		return x.SeqNo
	}
	return 0
...
type EpochChange_NetworkStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Loyalties []int64  `protobuf:"varint,1,rep,packed,name=loyalties,proto3" json:"loyalties,omitempty"`
	Timeouts  []uint64 `protobuf:"varint,2,rep,packed,name=timeouts,proto3" json:"timeouts,omitempty"`
	Leaders   []uint64 `protobuf:"varint,3,rep,packed,name=leaders,proto3" json:"leaders,omitempty"`
}

func (x *EpochChange_NetworkStatus) Reset() {
	*x = EpochChange_NetworkStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *EpochChange_NetworkStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EpochChange_NetworkStatus) ProtoMessage() {}

func (x *EpochChange_NetworkStatus) ProtoReflect() protoreflect.Message {
	mi := &file_msgs_msgs_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EpochChange_NetworkStatus.ProtoReflect.Descriptor instead.
func (*EpochChange_NetworkStatus) Descriptor() ([]byte, []int) {
	return file_msgs_msgs_proto_rawDescGZIP(), []int{21, 0}
}

func (x *EpochChange_NetworkStatus) GetLoyalties() []int64 {
	if x != nil {
		return x.Loyalties
	}
	return nil
...
func (x *EpochChange_NetworkStatus) GetTimeouts() []uint64 {
	if x != nil {
		return x.Timeouts
	}
	return nil
...
func (x *EpochChange_NetworkStatus) GetLeaders() []uint64 {
	if x != nil {
		return x.Leaders
	}
	return nil
...
func (*EpochChange_SetEntry) Descriptor() ([]byte, []int) {
	return file_msgs_msgs_proto_rawDescGZIP(), []int{21, 1}
}
...
var file_msgs_msgs_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x6d, 0x73, 0x67, 0x73, 0x22, 0x9e, 0x05, 0x0a, 0x0c, 0x4e, 0x65, 0x74, 0x77,
	...
	,
	...
	,
	...
	0x67, 0x1a, 0x31, 0x0a, 0x09, 0x4e, 0x65, 0x77, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x0e,
	...
	,
	...
	0x35, 0x0a, 0x06, 0x54, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x71,
	0x5f, 0x6e, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x65, 0x71, 0x4e, 0x6f,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x65, 0x0a, 0x06, 0x51, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	0x2c, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x73, 0x67, 0x73, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x41, 0x63, 0x6b, 0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x37, 0x0a,
	0x06, 0x50, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x71, 0x5f, 0x6e,
	...
	0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x06, 0x43, 0x45, 0x6e, 0x74, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x72, 0x0a, 0x0c, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64,
	0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x71, 0x5f, 0x6e, 0x6f, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x65, 0x71, 0x4e, 0x6f, 0x12, 0x33, 0x0a, 0x0c,
	...
	0x0c, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x66, 0x0a, 0x0e, 0x46, 0x6f, 0x72,
	0x77, 0x61, 0x72, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x31, 0x0a, 0x0b, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x61, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x10, 0x2e, 0x6d, 0x73, 0x67, 0x73, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41,
	0x63, 0x6b, 0x52, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x6b, 0x12, 0x21,
	...
	0x61, 0x22, 0x51, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x08, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x72, 0x65, 0x71,
	0x5f, 0x6e, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x72, 0x65, 0x71, 0x4e, 0x6f,
	0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x22, 0x58, 0x0a, 0x0a, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41,
	...
	,
	...
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x73, 0x67, 0x73, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x52, 0x0b, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x73, 0x12, 0x2f, 0x0a, 0x05, 0x70, 0x5f, 0x73, 0x65, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	0x0c, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x66, 0x0a, 0x0e, 0x45, 0x70, 0x6f,
	...
	,
	...
	,
	...
	0x66, 0x6c, 0x79, 0x32, 0x70, 0x6c, 0x61, 0x6e, 0x2f, 0x6d, 0x69, 0x72, 0x62, 0x66, 0x74, 0x2f,
...
var file_msgs_msgs_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_msgs_msgs_proto_goTypes = []interface{}{
	...
	(*Suspect_Context)(nil),            // 29: msgs.Suspect.Context
	(*EpochChange_NetworkStatus)(nil),  // 30: msgs.EpochChange.NetworkStatus
	(*EpochChange_SetEntry)(nil),       // 31: msgs.EpochChange.SetEntry
	(*NewEpoch_RemoteEpochChange)(nil), // 32: msgs.NewEpoch.RemoteEpochChange
}
var file_msgs_msgs_proto_depIdxs = []int32{
	...
	29, // 35: msgs.Suspect.context:type_name -> msgs.Suspect.Context
	30, // 36: msgs.EpochChange.status:type_name -> msgs.EpochChange.NetworkStatus
	19, // 37: msgs.EpochChange.checkpoints:type_name -> msgs.Checkpoint
	31, // 38: msgs.EpochChange.p_set:type_name -> msgs.EpochChange.SetEntry
	31, // 39: msgs.EpochChange.q_set:type_name -> msgs.EpochChange.SetEntry
	21, // 40: msgs.EpochChangeAck.epoch_change:type_name -> msgs.EpochChange
	23, // 41: msgs.NewEpochConfig.config:type_name -> msgs.EpochConfig
	19, // 42: msgs.NewEpochConfig.starting_checkpoint:type_name -> msgs.Checkpoint
	24, // 43: msgs.NewEpoch.new_config:type_name -> msgs.NewEpochConfig
	32, // 44: msgs.NewEpoch.epoch_changes:type_name -> msgs.NewEpoch.RemoteEpochChange
...
func file_msgs_msgs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_msgs_msgs_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EpochChange_NetworkStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
